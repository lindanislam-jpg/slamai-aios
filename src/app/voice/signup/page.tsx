    ...
    <div className="flex min-h-screen">
      <div className="flex w-full flex-col justify-center px-5 py-12 sm:px-10 lg:w-[55%] lg:px-16">
        <div className="mx-auto w-full max-w-md">
          <Link href="/voice" className="mb-8 flex items-center gap-2.5">
          ...
          <form className="mt-8 space-y-4" onSubmit={submit}>
            ...
            <p className="text-center text-[13px] text-slate-500">
              Already with us?{" "}
              <Link href="/voice/login" className="text-indigo-400 hover:underline">Sign in</Link>
            </p>
          </form>
        </div>
      </div>
